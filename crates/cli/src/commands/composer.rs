...
pub(crate) fn install(
    ...
    super::write_revoked_latest_warning(php_pair.php(), output)?;
    super::write_revoked_latest_warning(php_pair.frankenphp(), output)?;
    super::write_revoked_latest_warning(composer, output)?;
