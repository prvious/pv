...
fn redis_list_reports_running_state_ports_and_usage() -> anyhow::Result<()> {
    ...
    seed_running_resource(&paths, DEFAULT_TRACK, "tcp", 6379)?;
...
#[expect(
    ...
    reason = "CLI Redis tests create fixture directories"
)]
...
#[expect(
    clippy::disallowed_methods,
    reason = "CLI Redis tests write fixture files"
)]
