...
fn mysql_list_reports_running_state_ports_and_usage() -> anyhow::Result<()> {
    ...
    seed_running_resource(&paths, DEFAULT_TRACK, "tcp", 3306)?;
...
#[expect(
    ...
    reason = "CLI MySQL tests create fixture directories"
)]
...
#[expect(
    clippy::disallowed_methods,
    reason = "CLI MySQL tests write fixture files"
)]
