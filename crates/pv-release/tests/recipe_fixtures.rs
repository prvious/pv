    ...
    assert_eq!(
        ...
        vec![
            ...
            ArchiveRoot::new(
                ...
                "8.3",
                "darwin-amd64",
                "frankenphp-8.3.31-frankenphp1.12.4-pv2-darwin-amd64",
            ),
            ArchiveRoot::new(
                "frankenphp",
                "8.3",
                "darwin-arm64",
                "frankenphp-8.3.31-frankenphp1.12.4-pv2-darwin-arm64",
            ),
            ArchiveRoot::new(
                "frankenphp",
                "8.4",
                "darwin-amd64",
                "frankenphp-8.4.22-frankenphp1.12.4-pv2-darwin-amd64",
            ),
            ArchiveRoot::new(
                "frankenphp",
                "8.4",
                "darwin-arm64",
                "frankenphp-8.4.22-frankenphp1.12.4-pv2-darwin-arm64",
            ),
            ArchiveRoot::new(
                "frankenphp",
                "8.5",
                "darwin-amd64",
                "frankenphp-8.5.7-frankenphp1.12.4-pv2-darwin-amd64",
            ),
            ArchiveRoot::new(
                "frankenphp",
                "8.5",
                "darwin-arm64",
                "frankenphp-8.5.7-frankenphp1.12.4-pv2-darwin-arm64",
            ),
            ArchiveRoot::new(
                "mailpit",
                "1",
            ...
            ArchiveRoot::new("php", "8.3", "darwin-amd64", "php-8.3.31-pv2-darwin-amd64"),
            ArchiveRoot::new("php", "8.3", "darwin-arm64", "php-8.3.31-pv2-darwin-arm64"),
            ArchiveRoot::new("php", "8.4", "darwin-amd64", "php-8.4.22-pv2-darwin-amd64"),
            ArchiveRoot::new("php", "8.4", "darwin-arm64", "php-8.4.22-pv2-darwin-arm64"),
            ArchiveRoot::new("php", "8.5", "darwin-amd64", "php-8.5.7-pv2-darwin-amd64"),
            ArchiveRoot::new("php", "8.5", "darwin-arm64", "php-8.5.7-pv2-darwin-arm64"),
            ArchiveRoot::new(
                "postgres",
                "17",
                "darwin-amd64",
