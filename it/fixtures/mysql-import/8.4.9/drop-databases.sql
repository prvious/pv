...
/*!40000 DROP DATABASE IF EXISTS `admin`*/;
...
INSERT INTO `users` VALUES (1,'André; `analytics`',0x005CFF),(2,'a\\b',0x00FF);
...
/*!40000 DROP DATABASE IF EXISTS `analytics`*/;
...
/*!40000 DROP DATABASE IF EXISTS `Mixed-Name`*/;
...
--
-- Dumping data for table `café`
--

LOCK TABLES `café` WRITE;
/*!40000 ALTER TABLE `café` DISABLE KEYS */;
INSERT INTO `café` VALUES (1,'été');
/*!40000 ALTER TABLE `café` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `notes` VALUES (1,'admin.analytics');
