...
<?php endif; ?>
    ...
    <div class="bg-background relative">
        ...
        >
            <div class="bg-card text-accent rounded-full px-3 py-1.5 font-mono text-[11px] font-semibold">
                [ LOCAL DEV, SOLVED ]
            </div>
...
<?php endif; ?>
            ...
            <div class="flex items-center gap-3">
                <span class="border-accent bg-elevated text-foreground flex items-center gap-2 rounded-full border px-3 py-2 font-mono text-xs font-semibold">
                ...
                <span class="border-accent-orange bg-elevated text-foreground flex items-center gap-2 rounded-full border px-3 py-2 font-mono text-xs font-semibold">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.terminal','data' => ['title' => 'terminal','class' => 'w-full max-w-195 text-[12px] md:text-[13px]','xData' => '{ tab: \'php\' }']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'terminal','class' => 'w-full max-w-195 text-[12px] md:text-[13px]','x-data' => '{ tab: \'php\' }']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <div class="bg-background px-6 py-24 md:px-20">
        <div class="mx-auto max-w-6xl">
            <div class="grid items-center gap-16 md:grid-cols-2">
                ...
                <?php if (isset($component)) { $__componentOriginal2b87b9bf8d9e15ba9982d7ee0ea9f7f0 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal2b87b9bf8d9e15ba9982d7ee0ea9f7f0 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.terminal','data' => ['title' => 'terminal','class' => 'text-[13px]']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('terminal'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'terminal','class' => 'text-[13px]']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
            ...
            <div class="grid gap-6 md:grid-cols-3">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = [
                    ...
                    <div class="bg-elevated space-y-4 rounded-2xl p-6">
                        ...
                        <p class="text-muted font-mono text-[13px] leading-relaxed"><?php echo e($desc); ?></p>
                    </div>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
            </div>
        </div>
