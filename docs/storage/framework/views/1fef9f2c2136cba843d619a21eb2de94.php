...
## Artisan Commands
- Run Artisan commands directly via the command line (e.g., ___SINGLE_BACKTICK___<?php echo e($assist->artisanCommand('route:list')); ?>___SINGLE_BACKTICK___, ___SINGLE_BACKTICK___<?php echo e($assist->artisanCommand('tinker --execute "..."')); ?>___SINGLE_BACKTICK___).
- Use ___SINGLE_BACKTICK___<?php echo e($assist->artisanCommand('list')); ?>___SINGLE_BACKTICK___ to discover available commands and ___SINGLE_BACKTICK___<?php echo e($assist->artisanCommand('[command] --help')); ?>___SINGLE_BACKTICK___ to check parameters.
...
- To execute PHP code for debugging, run ___SINGLE_BACKTICK___<?php echo e($assist->artisanCommand('tinker --execute "your code here"')); ?>___SINGLE_BACKTICK___ directly.
- To read configuration values, read the config files directly or run ___SINGLE_BACKTICK___<?php echo e($assist->artisanCommand('config:show [key]')); ?>___SINGLE_BACKTICK___.
...
<?php /**PATH /Users/clovismuneza/Apps/pv/docs/storage/framework/views/9f3255b1c526e2cd2f014dc153881a19.blade.php ENDPATH**/ ?>