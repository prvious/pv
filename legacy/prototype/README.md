...
> This is the legacy prototype implementation. The active rewrite lives at the
> repository root. Keep this module buildable for reference, but do not import
> it from new rewrite code.
